...
def main():
    ...
    if args.article and args.num_vids > 1:
        ...
        console.print("Just supply an article name to make a single video")
        exit()
...
def display_banner():
    ...
    console.print(f"Console width is {console_width}")
    ...
    console.print(f"Tyler Weston 2021/2022. version# {__version__}", justify="center")
    console.rule()
    console.print()
